...
public class DaItemTouchHelpCallback extends ItemTouchHelper.Callback {
    /**
     * Item操作的回调
     */
    ...
    public DaItemTouchHelpCallback(OnItemTouchCallbackListener onItemTouchCallbackListener) {
        ...
        switch (actionState) {
            ...
            case ItemTouchHelper.ACTION_STATE_IDLE:
                ...
                if (onItemTouchCallbackListener != null) {
                     onItemTouchCallbackListener.onEnd();
                }
                break;
        }
    }
